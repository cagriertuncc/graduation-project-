...
export default function PharmacistLogin() {
    ...
    const { login, isPharmacistAuthenticated } = usePharmacistAuth();
    const [email, setEmail] = useState("eczane@hastane.com");
    ...
    useEffect(() => {
        if (isPharmacistAuthenticated) {
            navigate("/eczane/panel", { replace: true });
        }
    }, [isPharmacistAuthenticated, navigate]);
    ...
    return (
        <div style={{ minHeight: "100vh", display: "flex", background: "#f8fafc", overflow: "hidden", fontFamily: "'Inter', sans-serif" }}>
            ...
            <div className="side-image" style={{
                flex: "0 0 45%", position: "relative", background: "linear-gradient(135deg, #064e3b 0%, #059669 100%)",
                ...
                <div style={{ zIndex: 1, textAlign: "center", maxWidth: "500px" }}>
                    ...
                    <div style={{ marginTop: "48px", color: "white", opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s ease 0.4s" }}>
                        <h1 style={{ fontSize: "36px", fontWeight: 800, marginBottom: "16px", letterSpacing: "-1px" }}>MediTrack Eczane</h1>
                        <p style={{ fontSize: "16px", opacity: 0.9, lineHeight: "1.6" }}>Eczane ilaç teslimatlarını onaylayın, güncel ilaç sarf stoklarını, son kullanma tarihlerini ve kritik limit uyarılarını yönetin.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="form-container" style={{ flex: 1, display: "flex", flexDirection: "column", padding: "60px 80px", background: "white", position: "relative", justifyContent: "center" }}>
                <div style={{ width: "100%", maxWidth: "450px", margin: "0 auto" }} className="login-content">
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "60px" }}>
                        <div style={{ width: "40px", height: "40px", background: "#e6f4ea", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <RiHospitalLine style={{ fontSize: "24px", color: EMERALD }} />
                        </div>
                        <span style={{ fontWeight: 800, fontSize: "18px", color: "#0f172a", letterSpacing: "-0.5px" }}>MediTrack Eczane</span>
                    </div>

                    <div style={{ marginBottom: "40px" }}>
                        <h2 style={{ fontSize: "32px", fontWeight: 800, color: "#0f172a", marginBottom: "8px" }}>Eczane Girişi</h2>
                        <p style={{ color: "#64748b", fontSize: "15px" }}>Eczane yönetim paneline erişmek için kimlik bilgilerinizi girin.</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                        ...
                        <div>
                            ...
                            <div style={{ position: "relative" }}>
                                <div style={{ position: "absolute", left: "16px", top: "50%", transform: "translateY(-50%)", color: focusedField === "email" ? EMERALD : "#94a3b8", transition: "all 0.2s", zIndex: 1 }}>
                                    <FiMail size={18} />
                                </div>
                                <input
                                    type="email"
                        ...
                        <div>
                            ...
                            <div style={{ position: "relative" }}>
                                <div style={{ position: "absolute", left: "16px", top: "50%", transform: "translateY(-50%)", color: focusedField === "password" ? EMERALD : "#94a3b8", transition: "all 0.2s", zIndex: 1 }}>
                                    <FiLock size={18} />
                                </div>
                                <input
                                    ...
                                    style={{
                                        ...
                                        border: `2px solid ${focusedField === "password" ? EMERALD : "#f1f5f9"}`,
                        ...
                        <button type="submit" disabled={isLoggingIn} style={{
                            ...
                            boxShadow: "0 10px 25px -4px rgba(5, 150, 105, 0.3)", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
